...
static uint8_t SDCARD_IsDetected(void) {
	...
	return !GPIO_GETPINVAL(FATFS_USE_DETECT_PIN_PORT, FATFS_USE_DETECT_PIN_PIN);
#endif
...
static uint8_t SDCARD_IsWriteEnabled(void) {
	...
	return !GPIO_GETPINVAL(FATFS_USE_WRITEPROTECT_PIN_PORT, FATFS_USE_WRITEPROTECT_PIN_PIN);
#endif
